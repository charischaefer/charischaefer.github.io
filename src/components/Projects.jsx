        ...
        <div className="projects-grid-container">
          <div className="project-grid-item">
            <div className="project-card">
              <img src="%PUBLIC_URL%/journal-app.png" alt="Reflecta Journal App" />
          ...
          <div className="project-grid-item">
            <div className="project-card">
              <img src="%PUBLIC_URL%/world-clock.png" alt="World Clock App" />
          ...
          <div className="project-grid-item">
            <div className="project-card">
              <img src="%PUBLIC_URL%/budget-planner.png" alt="Budget Planner App" />
